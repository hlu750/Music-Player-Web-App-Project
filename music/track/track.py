...
#         prev_track_url = url_for('track_bp.tracks_by_genre', genre=genre_name, cursor=cursor - tracks_per_page)
#         first_track_url = url_for('track_bp.tracks_by_genre', genre=genre_name)
...
#         next_track_url = url_for('track_bp.tracks_by_genre', genre=genre_name, cursor=cursor + tracks_per_page)
...
#         last_track_url = url_for('track_bp.tracks_by_genre', genre=genre_name, cursor=last_cursor)

#     # Construct urls for viewing track reviews and adding reviews.
#     for track in tracks:
#         track['view_review_url'] = url_for('track_bp.tracks_by_genre', genre=genre_name, cursor=cursor, view_reviews_for=track['id'])
#         track['add_review_url'] = url_for('track_bp.review_on_track', track=track['id'])
...
#         return redirect(url_for('track_bp.tracks_by_date', date=track['date'], view_reviews_for=track_id))
...
#         track=track,
#         form=form,
#         handler_url=url_for('track_bp.review_on_track'),
...
#         # Generate the webluepringenree to display the tracks.
#         return render_template(
#             'track/tracks.html',
#             title='tracks',
